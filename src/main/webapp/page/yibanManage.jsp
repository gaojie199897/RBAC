...
<table id="dg" title="已办任务管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/task/finishedList.com.action?groupId=${currentMemberShip.group.id}&userId=${currentMemberShip.user.id }" fit="true" toolbar="#tb">
 <thead>
 	<tr>
