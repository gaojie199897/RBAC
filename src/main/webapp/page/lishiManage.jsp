...
<table id="dg" title="历史任务管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/task/finishedList.com.action?groupId=${currentMemberShip.group.id}" fit="true" toolbar="#tb">
 <thead>
 	<tr>
...
<div id="dlg2" class="easyui-dialog" style="width: 750px;height: 250px;padding: 10px 20px" closed="true" >
  ...
  fitColumns="true"  
  url="${pageContext.request.contextPath}/task/listHistoryComment.com.action" style="width: 700px;height: 200px;">
 <thead>
 	<tr>
...
<div id="dlg3" class="easyui-dialog" style="width: 750px;height: 350px;padding: 10px 20px" closed="true" >
  ...
  fitColumns="true"  
  url="${pageContext.request.contextPath}/task/listAction.com.action" style="width: 700px;height: 250px;">
 <thead>
 	<tr>
