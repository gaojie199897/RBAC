...
<script type="text/javascript">
	function deleteGroup(){
		...
		$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectRows.length+"</font>条数据吗?",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/group/deleteGroup.com.action",{ids:ids},function(result){
					if(result.success){
	...
	function saveGroup(){
		$("#fm").form("submit",{
			url:'${pageContext.request.contextPath}/group/groupSave.com.action',
			onSubmit:function(){
...
<table id="dg" title="角色管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/group/groupPage.com.action" fit="true" toolbar="#tb">
 <thead>
 	<tr>
