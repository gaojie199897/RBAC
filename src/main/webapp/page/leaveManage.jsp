...
<script type="text/javascript">
	...
	function saveLeave(){
		$("#fm").form("submit",{
			url:'${pageContext.request.contextPath}/leave/save.com.action',
			onSubmit:function(){
	...
	function startApply(leaveId){
		$.post("${pageContext.request.contextPath}/leave/startApply.com.action",{leaveId:leaveId},function(result){
			if(result.success){
...
<table id="dg" title="请假管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/leave/leavePage.com.action" fit="true" toolbar="#tb">
 <thead>
 	<tr>
 		...
 		<th field="com.action" width="50" align="center" formatter="formatAction">操作</th>
 	</tr>
 </thead>
</table>
<div id="tb">
...
<div id="dlg2" class="easyui-dialog" style="width: 750px;height: 250px;padding: 10px 20px" closed="true" >
  ...
  fitColumns="true"  
  url="${pageContext.request.contextPath}/task/listHistoryCommentWithProcessInstanceId.com.action" style="width: 700px;height: 200px;">
 <thead>
 	<tr>
