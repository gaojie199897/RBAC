...
<script type="text/javascript">
	...
	function formatAction(val,row){
		return "<a href='${pageContext.request.contextPath}/processDefinition/showView.com.action?deploymentId="+row.deploymentId+"&diagramResourceName="+row.diagramResourceName+"' target='_blank'>查看流程图</a>"
	}
</script>
</head>
...
<table id="dg" title="流程定义管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/processDefinition/processDefinitionPage.com.action" fit="true" toolbar="#tb">
 <thead>
 	<tr>
