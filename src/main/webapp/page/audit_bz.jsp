...
<script type="text/javascript">
	function submit(state){
		$("#fm").form("submit",{
			url:'${pageContext.request.contextPath}/task/audit_bz.com.action?state='+state,
			onSubmit:function(){
	...
	$(function(){
		$.post("${pageContext.request.contextPath}/leave/getLeaveByTaskId.com.action",{taskId:'${param.taskId}'},function(result){
...
<table id="dg" title="批注列表" class="easyui-datagrid"
  fitColumns="true"
  url="${pageContext.request.contextPath}/task/listHistoryComment.com.action?taskId=${param.taskId}" style="width: 700px;height: 200px;">
 <thead>
 	<tr>
